...
class Endangered {
 public:
  virtual ~Endangered() { std::cout << "Endangered dtor" << std::endl; }
...
class ZooAnimal {
 public:
  ...
  virtual ~ZooAnimal() { std::cout << "Animal dtor" << std::endl; }
...
class Bear : public ZooAnimal {
 public:
  ...
  void dance(DanceType) const { std::cout << "Bear::dance" << std::endl; }

  virtual ~Bear() { std::cout << "Bear dtor" << std::endl; }
...
class Panda : public Bear, public Endangered {
 public:
  ...
  virtual ~Panda() { std::cout << "Panda dtor" << std::endl; }
  virtual std::ostream& print() const {
